...
export GATEKEEPER_OPERATOR_IMAGE_PULLSPEC="quay.io/redhat-user-workloads/konflux-samples-tenant/olm-operator/gatekeeper-operator@sha256:ee1ca256f57fa78f6606c3036cb7a369ae333eb665168d3a51da5760c890b3bc"
